            ...
            <div className="container">
                <div className="row mt-3">
                    <div className="col-lg-3">
                       ...
                       <p className="mt-3">Visit us today and immerse yourself in our world of plant-based delights. Explore our latest recipes, meet our expert team, and discover the joy of wholesome, veggie-inspired living.</p>
                    ...
                    <div className="col-lg-3 mt-2">
                        ...
                        <p>Stay updated with our latest plant-based recipes and nutrition tips by subscribing to our newsletter. Get delicious, veggie-filled inspiration delivered straight to your inbox!</p>
