...
const Blog = (props) => {
  return (
    <div className="blog container mt-5">
                ...
                <p className="text-center">Discover the freshest plant-based recipes and nutrition tips in our latest blog post, celebrating the vibrant flavors and health benefits of seasonal vegetables. Dive into our expert guides to enhance your culinary skills and embrace a wholesome, veggie-filled lifestyle.</p>
                </>
